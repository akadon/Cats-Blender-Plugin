...
translations_tuple = (
    ...
    (
        ...
        (("bpy.types.mmd_tools_local_OT_change_mmd_ik_loop_factor", "extensions/blender_org/mmd_tools_local/panels/prop_object.py:34", "extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:167"), ()),
    ...
    (
        ...
        (("bpy.types.mmd_tools_local_OT_separate_by_materials", "extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:140"), ()),
    ...
    (
        ("*", "Clean Shape Keys"),
        (("bpy.types.mmd_tools_local_OT_separate_by_materials.clean_shape_keys", "bpy.types.mmd_tools_local_OT_separate_by_parts.clean_shape_keys"), ()),
    ...
    (
        ...
        (("bpy.types.mmd_tools_local_OT_separate_by_parts", "extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:139"), ()),
        ("ja_JP", "部品で分離", (False, ())),
        ("zh_HANS", "按部件分开", (False, ())),
    ),
    (
        ("*", "Separate by loose parts and join by materials.\nThis preserves vertex count."),
        (("bpy.types.mmd_tools_local_OT_separate_by_parts",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Toon Texture"),
        (("bpy.types.MMDMaterial.toon_texture", "extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:149"), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools_local/operators/fileio.py:958",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", '[跳过] 找不到 MMD 模型"%s"的骨架数据', (True, ())),
    ),
    (
        ("*", 'Exported MMD model "" to ""'),
        (("extensions/blender_org/mmd_tools_local/operators/fileio.py:990",), ()),
    ...
    (
        ("*", "Select a MMD model"),
        (("extensions/blender_org/mmd_tools_local/operators/material.py:417", "extensions/blender_org/mmd_tools_local/operators/misc.py:271", "extensions/blender_org/mmd_tools_local/operators/misc.py:317"), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools_local/operators/misc.py:378",), ()),
        ("ja_JP", "この操作は既存のFカーブ/アクションを破壊します", (False, ())),
        ("zh_HANS", "这一操作将破坏现有的函数曲线/动作", (False, ())),
    ),
    (
        ("*", "Click [OK] to run the operation."),
        (("extensions/blender_org/mmd_tools_local/operators/misc.py:379",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools_local/operators/misc.py:281",), ()),
        ("ja_JP", "このモデルにはメッシュがありません", (False, ())),
        ("zh_HANS", "该模型不具有任何网格", (False, ())),
    ),
    (
        ("*", "Model Armature not found"),
        (("extensions/blender_org/mmd_tools_local/operators/misc.py:322",), ()),
    ...
    (
        ("*", "Filter"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:265",), ()),
        ("ja_JP", "フィルタ", (False, ())),
        ("zh_HANS", "筛选", (False, ())),
    ),
    (
        ("*", "is Blank:"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:269",), ()),
        ("ja_JP", "空白のみ:", (False, ())),
        ("zh_HANS", "是空白:", (False, ())),
    ),
    (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:305",), ()),
        ("ja_JP", "一括操作の対象列を選択:", (False, ())),
        ("zh_HANS", "选择批量操作的目标列:", (False, ())),
    ),
    (
        ("*", "Batch Operation:"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:326",), ()),
        ("ja_JP", "一括操作:", (False, ())),
        ("zh_HANS", "批量操作:", (False, ())),
    ),
    (
    ...
    (
        ("Operator", "Execute"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:337",), ()),
        ("ja_JP", "実行", (False, ())),
        ("zh_HANS", "执行", (False, ())),
    ),
    (
        ("*", "Dictionaries:"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:341",), ()),
        ("ja_JP", "辞書:", (False, ())),
        ("zh_HANS", "词典:", (False, ())),
    ),
    (
    ...
    (
        ("*", "CSV:"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:352",), ()),
        ("ja_JP", "CSV:", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Import CSV"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:354",), ()),
    ...
    (
        ("*", "Exported to "),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:443",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Failed to translate  names, see '' in text editor"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:110", "extensions/blender_org/mmd_tools_local/operators/translations.py:393"), ()),
        ("ja_JP", "名称  の翻訳に失敗しました, テキストエディタで '' を確認してください", (False, ())),
        ("zh_HANS", "未能翻译  个名称，参见文本编辑器中的 ''", (False, ())),
    ),
    (
        ("*", "Root object not found"),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:425", "extensions/blender_org/mmd_tools_local/operators/translations.py:473"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Failed to write CSV: "),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:440",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Failed to read CSV: "),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:538",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Missing required headers in CSV: , "),
        (("extensions/blender_org/mmd_tools_local/operators/translations.py:488",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("Operator", "Join"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_production.py:62", "extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:141"), ()),
        ("ja_JP", "統合", (False, ())),
        ("zh_HANS", "合并", (False, ())),
    ),
    (
    ...
    (
        ("*", "Material:"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:145",), ()),
        ("ja_JP", "マテリアル:", (False, ())),
        ("zh_HANS", "材质:", (False, ())),
    ),
    (
        ("*", "Sphere Texture"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:150",), ()),
        ("ja_JP", "スフィアテクスチャ", (False, ())),
        ("zh_HANS", "球体纹理", (False, ())),
    ),
    (
        ("Operator", "Convert to Blender"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:155",), ()),
        ("ja_JP", "Blender用に変換", (False, ())),
        ("zh_HANS", "转换给Blender", (False, ())),
    ),
    (
        ("Operator", "Convert to MMD"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:157",), ()),
        ("ja_JP", "MMD用に変換", (False, ())),
    ...
    (
        ("*", "Misc:"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:164",), ()),
        ("ja_JP", "その他:", (False, ())),
        ("zh_HANS", "杂项:", (False, ())),
    ),
    (
        ("Operator", "(Experimental) Global Translation"),
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:166",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools_local/panels/sidebar/model_setup.py:152",), ()),
        ("ja_JP", "輪郭プレビュー", (False, ())),
        ("zh_HANS", "边缘预览", (False, ())),
    ),
    (
